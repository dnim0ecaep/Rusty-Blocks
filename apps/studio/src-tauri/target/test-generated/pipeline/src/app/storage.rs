...
//!
//! Storage layout: `<user-data-dir>/pipelinetest/<key>.json` for structured
//! state, `<user-data-dir>/pipelinetest/<name>.txt` for free-form text.
...
const APP_SLUG: &str = "pipelinetest";
